            ...
            <div class="modal-body">
                ...
                <form id="editInv<?php echo $fila['id']; ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label for="password">Area de asignacion</label><br>
                                <select name="id_area" id="id_area" class="form-control" required>
                                    <option <?php echo $fila['id_area'] === 'id_area' ? 'selected' : ''; ?> value="<?php echo $fila['id_area']; ?>"><?php echo $fila['id_area']; ?></option>
                                    <?php
                                    ...
                                    while ($consulta = mysqli_fetch_array($resultado)) {
                                        $selected = $fila['id_area'] === $consulta['id'] ? 'selected' : '';
