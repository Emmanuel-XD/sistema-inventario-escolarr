...
<?php
$id = $_GET['id'];
$sql = "SELECT  u.id, u.usuario, u.correo, u.password, u.fecha, u.imagen, u.sexo, p.rol FROM users u
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $fila['sexo']; ?></div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        ...
                                        <form id="form" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Sexo</label>
                                                <div class="col-md-8 col-lg-9">
                                                    <select name="sexo" id="sexo" class="form-control" required>
                                                        <option <?php echo $fila['sexo'] === 'Masculino' ? 'selected' : ''; ?> value="Masculino">Masculino</option>
                                                        <option <?php echo $fila['sexo'] === 'Femenino' ? 'selected' : ''; ?> value="Femenino">Femenino</option>
